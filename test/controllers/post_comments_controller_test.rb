...
class PostCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_comment" do
    assert_difference("PostComment.count") do
      post post_comments_url, params: { post_comment: { content: @post_comment.content, created_by_id: @post_comment.created_by_id, post_id: @post_comment.post_id } }
    end
  ...
  test "should update post_comment" do
    patch post_comment_url(@post_comment), params: { post_comment: { content: @post_comment.content, created_by_id: @post_comment.created_by_id, post_id: @post_comment.post_id } }
