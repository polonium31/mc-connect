...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference("Like.count") do
      post likes_url, params: { like: { liked_by_id: @like.liked_by_id, user_id: @like.user_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { liked_by_id: @like.liked_by_id, user_id: @like.user_id } }
